...
/**
 * @author Greg Hinkle (ghinkle@users.sourceforge.net), Nov 15, 2005
...
public class EmsMalformedObjectNameException extends EmsException {
    ...
    public EmsMalformedObjectNameException(String message) {
        super(message);
    }

    public EmsMalformedObjectNameException(String message, Throwable cause) {
        super(message, cause);
    }
